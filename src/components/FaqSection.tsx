const faqs = [
    ...
    },
    {
        ...
        answer: "ヨシレンタカーでは25〜29人乗りマイクロバスを1日30,000円（税抜）〜でご提供しています。沖縄県民割引もございます。観光旅行・社員旅行・団体旅行・空港送迎のほか、ロケバスや撮影など法人利用にもご利用いただけます。",
    },
    {
        question: "ロケバス・撮影用としてマイクロバスを借りられますか？",
        answer: "はい、映像制作・CM撮影・TV番組のロケバスとしてご利用いただけます。制作会社やイベント会社など法人のお客様にも多くご利用いただいております。撮影スケジュールに合わせた長期レンタルにも対応しておりますので、お気軽にご相談ください。",
    },
    {
        question: "マイクロバスの長期レンタルプランはありますか？",
        answer: "週額185,000円（税込）〜、月額385,000円（税込）〜の長期レンタルプランをご用意しています。ロケバス・法人利用・長期出張など、まとまった期間のご利用に最適です。詳細はLINEまたはお電話でお問い合わせください。",
    },
];
